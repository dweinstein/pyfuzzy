...
__revision__ = "$Id: SchweizerIntersection.py,v 1.7 2009-10-27 19:26:05 rliebscher Exp $"
...
class SchweizerIntersection(ParametricNorm):
    ...
    def __init__(self, param=1.):
        super(SchweizerIntersection, self).__init__(ParametricNorm.T_NORM, param)
